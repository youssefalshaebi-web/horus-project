/** قيم افتراضية لواجهة المتجر — يُوازَى src/storefrontUiDefaults.ts */
...
export function getDefaultUiSettings() {
  return {
    ...
    uiOrderSuccess: {
      ...
      totalLabel: 'المجموع',
      footerLead:
        'احتفظ برقم الطلب للمراجعة. يمكنك متابعة حالة الطلب ورقم التتبع من صفحة',
